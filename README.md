...
class FizzBuzz {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < 100; i++) {
            ...
            // Find out which numbers divide i (divisibleBy3 is a variable).
...
strike you as either similar to or different from Python. 
  - && is and
  - else if is elif
  - i++ is post increment so after the for loop, ++i is pre increment
...
public static void main(String[] args)
```
- include this before you write ur code ^^
